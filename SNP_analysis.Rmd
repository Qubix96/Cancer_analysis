...
corrplot(MLR_data, method = "square")
```
...
Optimal_Clusters_KMeans(data = MLR_data, max_clusters = 15, criterion = "WCSSE")


k_mean <- kmeans(MLR_data, centers = 7, nstart = 25)


fviz_cluster(k_mean, data = MLR_data)
