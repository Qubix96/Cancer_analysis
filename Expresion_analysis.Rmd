...
ggsave(filename = "Figures/alive_decease_breast_1", dpi = 600)
...
ggsave(filename = "Figures/alive_decease_breast_2", dpi = 600)
...
ggsave(filename = "Figures/alive_decease_breast_3", dpi = 600)
...
ggsave(filename = "Figures/alive_decease_breast_4", dpi = 600)
...
tiff("Figures/rpart_ovary_expression.jpeg" , units="in", width=10, height=5, res=300)
